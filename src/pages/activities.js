    ...
    return (
        <div>
            <div className="activities-container">
                ...
                <p className="activities-text">
                Check out this week’s lineup below — and don’t forget to ask our 
                team at reception if you have any questions or want to join in!
                </p>
            </div>
